    ...
    <div class='row'>
      <div class="col-sm-12">
        ...
        <div class="text-center">
          <h2>Sistem Informasi Perpustakan SMP N 1 Karangpandan</h2>
          <h4>Jl Tp. Jokosongo, Doplang<br>Kec. Karangpandan, Kabupaten Karanganyar, Jawa Tengah 57791</h4>
          <hr>
